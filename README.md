...
dvc run -d data/splitter/train.csv -d data/splitter/validation.csv -d src/decision_tree.py -o data/decision_tree/user1.pkl -M results/score.txt python src/decision_tree.py
```
